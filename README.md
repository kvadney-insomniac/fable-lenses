...
high-leverage work *ready to point a premium model at* — instead of letting it
...
- **impact = git churn** — exact, from git history. No model tokens spent
  estimating what the repository already knows.
